...
describe('Dialog', function() {
  ...
  describe('setDefaultPath', function() {
    ...
    it('should guess file if path does not exist', function() {
    ...
    it('should guess directory if path does not exist', function() {

      // given
      const dirPath = path.join(__dirname, 'fixtures/bar/');
