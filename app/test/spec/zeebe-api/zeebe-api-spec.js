  ...
  describe('#deploy', function() {
    ...
    it('should read file as buffer', async function() {
      ...
      expect(fs.readFile.args).to.eql([
        [ parameters.files[0].path, { encoding: false } ]
      ]);
    });
    ...
    describe('resource names', function() {
      ...
      it('should accept deployment name as resource name if single file', async function() {
        ...
        // then
        expect(args[0].name).to.eql('bar.bpmn');
      });


      it('should accept deployment name as resource name and add extension if single file', async function() {
      ...
      it('should not accept deployment name as resource name if multiple files', async function() {
        ...
        expect(args[0][1].name).to.eql('bar.dmn');
      });


      it('should add .bpmn extension to deployment name to create resource name', async function() {
      ...
      it('should add .dmn extension to deployment name to create resource name', async function() {
        ...
        // then
        expect(args[0].name).to.eql('bar.dmn');
      });


      it('should add .form extension to deployment name to create resource name', async function() {
        ...
        // then
        expect(args[0].name).to.eql('bar.form');
      });


      it('should not add .bpmn extension deployment name to create resource name', async function() {
      ...
      it('should not add .dmn extension deployment name to create resource name', async function() {
      ...
      it('should not add .form extension deployment name to create resource name', async function() {
      ...
      it('should use file path as resource name by default', async function() {
