...
* [ ] create release candidate (`npm run release`), e.g. v1.0.0-rc.0
    * [ ] wait for [GitHub Actions](https://github.com/camunda/camunda-modeler/actions/workflows/RELEASE.yml) to build the executables
