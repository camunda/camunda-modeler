      ...
      }) } id="process-application-overlay" anchor={ ref.current } onClose={ () => setIsOpen(false) }>
        {
          !processApplication
            ? <>
              <Section>
                <Section.Body>
                  <p>Turn your project into a process application to</p>
                  <ul>
                    <li>Treat resources (BPMN, DMN, Forms) as one unit during deployment and local testing</li>
                  ...
                  <p><a href="https://docs.camunda.io/docs/next/components/concepts/process-applications/" target="_blank" rel="noopener noreferrer">Learn more</a></p>
                </Section.Body>
              </Section>
            </>
            : <>
