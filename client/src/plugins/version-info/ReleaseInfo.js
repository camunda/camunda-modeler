...
export function ReleaseInfo(props) {
  return (
    <div className={ css.ReleaseInfo }>
      <ul className="dashed">
        <li>
          <h4>Enhanced BPMN Ad-hoc Subprocess Support</h4>
          You can now configure new ad-hoc subprocess properties such as output collection and implementation as a job worker.
        </li>
        <li>
          <h4>Support for deployment using the new Orchestration Cluster API</h4>
          The modeler now supports deploying through the new <a href="https://docs.camunda.io/docs/8.8/apis-tools/orchestration-cluster-api-rest/orchestration-cluster-api-rest-overview/">Orchestration Cluster API</a>.
        </li>
        <li>
