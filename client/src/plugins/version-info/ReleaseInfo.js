    ...
    <div className={ css.ReleaseInfo }>
      <ul className="dashed">
        <li>
          ...
          This release improves the handling of broken diagram validation rules, adding a safe guard for authors and users of <a href="https://github.com/camunda/camunda-modeler-custom-linter-rules-plugin">custom linter rule plug-ins</a>.
        </li>
        <li>
