    ...
    describe('invalid', function() {
      ...
      it('Camunda 8 SaaS (endpoint.camundaCloudClusterUrl empty)', function() {
        expectValidationErrors({
          ...
          deployment: {},
          endpoint: {
            camundaCloudClientId: null,
            camundaCloudClientSecret: null,
            camundaCloudClusterUrl: VALIDATION_ERROR_MESSAGES.CLUSTER_URL_MUST_NOT_BE_EMPTY
          }
        });
      });
      ...
      it('Camunda 8 SaaS (endpoint.camundaCloudClusterUrl invalid)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            camundaCloudClientId: null,
            camundaCloudClientSecret: null,
            camundaCloudClusterUrl: VALIDATION_ERROR_MESSAGES.CLUSTER_URL_MUST_BE_VALID_CLOUD_URL
          }
        });
      });
      ...
      it('Camunda 8 SaaS (endpoint.camundaCloudClientId empty)', function() {
        expectValidationErrors({
          ...
          deployment: {},
          endpoint: {
            camundaCloudClientId: VALIDATION_ERROR_MESSAGES.CLIENT_ID_MUST_NOT_BE_EMPTY,
            camundaCloudClientSecret: null,
      ...
      it('Camunda 8 SaaS (endpoint.camundaCloudClientSecret empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            camundaCloudClientId: null,
            camundaCloudClientSecret: VALIDATION_ERROR_MESSAGES.CLIENT_SECRET_MUST_NOT_BE_EMPTY,
            camundaCloudClusterUrl: null
          }
        });
      });
      ...
      it('Camunda 8 self-managed (endpoint.contactPoint empty)', function() {
        expectValidationErrors({
          ...
          deployment: {},
          endpoint: {
            contactPoint: VALIDATION_ERROR_MESSAGES.CONTACT_POINT_MUST_NOT_BE_EMPTY
          }
        });
      });
      ...
      it('Camunda 8 self-managed (endpoint.basicAuthUsername empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            contactPoint: null,
            basicAuthUsername: VALIDATION_ERROR_MESSAGES.BASIC_AUTH_USERNAME_MUST_NOT_BE_EMPTY,
      ...
      it('Camunda 8 self-managed (endpoint.basicAuthPassword empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            ...
            basicAuthPassword: VALIDATION_ERROR_MESSAGES.BASIC_AUTH_PASSWORD_MUST_NOT_BE_EMPTY
          }
        });
      });
      ...
      it('Camunda 8 self-managed (endpoint.oauthURL empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            contactPoint: null,
            oauthURL: VALIDATION_ERROR_MESSAGES.OAUTH_URL_MUST_NOT_BE_EMPTY,
            clientId: null,
            clientSecret: null,
            audience: null
          }
      ...
      it('Camunda 8 self-managed (endpoint.clientId empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            contactPoint: null,
            oauthURL: null,
            clientId: VALIDATION_ERROR_MESSAGES.CLIENT_ID_MUST_NOT_BE_EMPTY,
            clientSecret: null,
            audience: null
          }
        });
      ...
      it('Camunda 8 self-managed (endpoint.clientSecret empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            ...
            oauthURL: null,
            clientId: null,
            clientSecret: VALIDATION_ERROR_MESSAGES.CLIENT_SECRET_MUST_NOT_BE_EMPTY,
            audience: null
          }
        });
      });
      ...
      it('Camunda 8 self-managed (endpoint.audience empty)', function() {
        expectValidationErrors({
          ...
          endpoint: {
            ...
            clientId: null,
            clientSecret: null,
            audience: VALIDATION_ERROR_MESSAGES.AUDIENCE_MUST_NOT_BE_EMPTY
          }
        });
      });
...
function expectNoValidationErrors(config) {
  ...
  // then
  for (const key in validationErrors.deployment) {
    expect(validationErrors.deployment[key]).to.be.null;
  }

  for (const key in validationErrors.endpoint) {
    expect(validationErrors.endpoint[key]).to.be.null;
  }
}