      ...
      'connectionManagerPlugin.c8connections': {
        ...
        constraints:{
          custom: async (values) => {
            ...
            try {
              const connectionCheckResult = await zeebeAPI.checkConnection(values);

              if (connectionCheckResult.success !== true) {
                return getConnectionCheckFieldErrors(connectionCheckResult);
              }
            } catch (e) {


              return getConnectionCheckFieldErrors(e);
            }
            return null;
          }
        },
