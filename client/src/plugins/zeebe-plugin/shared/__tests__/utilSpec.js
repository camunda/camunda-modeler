      ...
      expect(deploymentUrls).to.eql([
        {
          ...
          url: 'https://yyy-1.operate.camunda.io/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/decisions?name=Foo&version=1'
        },
        {
          decisionId: 'Decision_2',
          url: 'https://yyy-1.operate.camunda.io/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/decisions?name=Bar&version=1'
        }
      ]);
    });
