...
describe('cloud-bpmn - <BpmnEditor>', function() {
  ...
  describe('layout', function() {
    ...
    describe('variables panel', function() {
      ...
      it('should emit variableOutline:layoutChanged when panel closes', async function() {
      ...
      it('should emit variableOutline:layoutChanged when panel opens', async function() {
      ...
      it('should NOT emit variableOutline:layoutChanged when open state is unchanged', async function() {
        ...
        // then
        expect(onActionSpy).not.to.have.been.calledWithMatch('emit-event', {
          type: 'variableOutline:layoutChanged'
        });
      });


      it('should NOT emit variableOutline:layoutChanged when resizing with default layout', async function() {
