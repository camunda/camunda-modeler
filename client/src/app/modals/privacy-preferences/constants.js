...
export const PRIVACY_POLICY_URL = 'https://camunda.com/legal/privacy/';
...
export const PREFERENCES_LIST = [
  {
    ...
    explanation: 'Allow Camunda Modeler to send crash reports containing stack traces and unhandled exceptions.',
