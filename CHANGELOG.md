...
* `FEAT`: support Camunda projects ([#6194](https://github.com/camunda/camunda-modeler/pull/6194))
...
* `FEAT`: highlight elements writing/reading a variable ([#5934](https://github.com/camunda/camunda-modeler/issues/5934))
...
* `FEAT`: add regex validation for tenant ID ([#5905](https://github.com/camunda/camunda-modeler/issues/5905))
* `FEAT`: indicate lint errors before deployment, test, or instance start ([#5804](https://github.com/camunda/camunda-modeler/issues/5804))
* `FEAT`: use EU endpoint for tracking ([#5973](https://github.com/camunda/camunda-modeler/pull/5973))
...
* `FEAT`: support headers on execution listeners ([#5817](https://github.com/camunda/camunda-modeler/issues/5817))
...
* `FIX`: make title specific for each attached event ([#5080](https://github.com/camunda/camunda-modeler/issues/5080))
