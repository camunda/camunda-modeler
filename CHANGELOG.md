...
* `FEAT`: new connection manager to store multiple Camunda 8 cluster connections and easily switch between them ([#4972](https://github.com/camunda/camunda-modeler/issues/4972))
